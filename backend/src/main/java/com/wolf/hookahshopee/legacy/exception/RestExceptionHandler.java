...
import com.wolf.hookahshopee.legacy.exception.apierror.ApiError;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleEntityHasRelationshipsException(EntityHasRelationshipsException ex) {
        ApiError apiError = new ApiError(CONFLICT);
        apiError.setMessage(ex.getMessage());
        return buildResponseEntity(apiError);
    }
    ...
    protected ResponseEntity<Object> handleEntityHasRelationshipsException(LogicalException ex) {
        ApiError apiError = new ApiError(CONFLICT);
        apiError.setMessage(ex.getMessage());
        return buildResponseEntity(apiError);
    }
